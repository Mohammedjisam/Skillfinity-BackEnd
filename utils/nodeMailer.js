                      ...
                      <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                          <td align="center" style="padding-bottom: 30px;">
                            <img src="https://via.placeholder.com/180x60?text=Skillfinity" alt="Skillfinity Logo" style="max-width: 180px; height: auto;">
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="padding-bottom: 30px;">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                              ...
                              <tr>
                                <td align="center">
                                  <p style="color: #666666; font-size: 14px; line-height: 21px; margin: 0;">This OTP will expire in 10 minutes for security reasons.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td style="padding-bottom: 30px;">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                              ...
                              <tr>
                                <td align="center">
                                  <p style="color: #666666; font-size: 14px; line-height: 21px; margin: 0;">If you didn't request this OTP, please ignore this email.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                  ...
                  <tr>
                    <td style="background-color: #f8f9fa; border-top: 1px solid #e9ecef; padding: 20px 40px; border-radius: 0 0 8px 8px;">
                      <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                          <td align="center">
                            <p style="color: #999999; font-size: 12px; line-height: 18px; margin: 0;">© 2023 Skillfinity. All rights reserved.</p>
                          </td>
                        </tr>
                      </table>
                    </td>
